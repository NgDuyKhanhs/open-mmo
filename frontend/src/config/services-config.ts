...
export const SERVICES_CONFIG = {
  earning: [
    {
      title: 'Selling Through Email with AI',
      desc: 'Build high-converting email funnels with AI-driven segmentation, personalization, and automated campaigns.',
      icon: '📧',
      revenue: '$800-$8000/month',
    },
    {
      title: 'SEO with AI',
      desc: 'Use AI for keyword research, content optimization, and technical SEO improvements to grow organic traffic.',
      icon: '🔍',
      revenue: '$600-$6000/month',
    },
    {
      title: 'Create a Website with AI',
      desc: 'Launch modern websites quickly with AI-assisted design, content generation, and conversion-focused structure.',
      icon: '🧩',
